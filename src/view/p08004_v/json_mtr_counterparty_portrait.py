...
class JsonMtrCounterpartyPortrait(TransFlow):
    """
        主要交易对手模块信息
    """
    ...
    def read_u_pt(self):
        ...
        if df.shape[0] == 0:
            self.variables["trans_u_counterparty_portrait"]['analyse_start_time'] = None
            self.variables["trans_u_counterparty_portrait"]['analyse_end_time'] = None
            return
        ...
        analyse_start_time = df['analyse_start_time'].iloc[0]
        analyse_end_time = df['analyse_end_time'].iloc[0]
        self.variables["trans_u_counterparty_portrait"]['analyse_start_time'] = analyse_start_time
        self.variables["trans_u_counterparty_portrait"]['analyse_end_time'] = analyse_end_time
