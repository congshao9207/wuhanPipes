...
class T33001(Transformer):
    ...
    def clean_variables(self):
        ...
        self.variables['yf_small_loan_guar_org_cnt'] = int(get_filed_value(df, 'loan_orgnum', 'loan_guarantee_total'))
        self.variables['yf_consume_fin_org_cnt'] = int(get_filed_value(df, 'loan_orgnum', 'consumer_finance_total'))
